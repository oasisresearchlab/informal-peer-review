...
2. code loose memo [[2024-11-12, Jay requests review subreddit PeerReview]]

---

I tidied the coding tree on the right side as I went about the process and needed to merge some what and where nodes because they overlapped.

I added some structure to the left hand pane (sites) according to the @ zhang2024 paper on social media form-from typology.
...
#inpeer/why/benefits/infrastructuring 
- The means that someone is engaging in infrastructuring for informal peer reviews.
