...
#### Workflow
1. I'm coding first in the memos.
2. Then, I'll code in the raw data (e.g. social media posts).

I organized subfolders in memos for Case Memos and Meta Memos.

I now have [[bishop bishopblog, autism intervention]] to start with and complete notes:
1. appraisals
2. appraisers
3. papers
4. sites
...
I am getting the hang of this, but am slow. I add codes and modified the code tree:

who
#inpeer/who/reviewer/roles/hero/sciReformer is someone who can be considered a science reformer due to research activities, advocacy, and/or employment with any organization (even their own org) that attempts to reform scholarship.
...
#inpeer/how/practices/review/paper/layers/theoretic/senselessResult for results that are not theoretically sensible
