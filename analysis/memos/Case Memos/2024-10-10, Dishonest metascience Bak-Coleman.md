...
- What is the relationship between informal peer review and the broader sociotechnical infrastructure of science? Explore:
    - Technical: posting between PubPeer, social media sites, and publishers’ platforms, etc.
        - PubPeer
            - [PubPeer](https://pubpeer.com/publications/A98F46F301606E700D42299753F8BF)
	            - #inpeer/evdInfra/where/multimedia/pubpeer/sparse
		            - This means that PubPeer is being used to record informal peer reviews, but there is sparse information on it (at the time of coding, but it could later be more populated).
                - Markdown
                    - --
                    - created: 2024-10-09T18:47:17 (UTC -04:00)
                    - tags: []
                    - source: [https://pubpeer.com/publications/A98F46F301606E700D42299753F8BF](https://pubpeer.com/publications/A98F46F301606E700D42299753F8BF)
                    - author:
                    - --
                    - # PubPeer - High replicability of newly discovered social-behavioural fi...

                    - > ## Excerpt
                    - > There are comments on PubPeer for publication: High replicability of newly discovered social-behavioural findings is achievable (2023)
                    - --
                    - Nature Human Behaviour (2023) - 2 Comments
                    - doi: 10.1038/s41562-023-01749-9  issn: 2397-3374  pubmed: 37945809 
                    - ___
        ...
        - Social Media
            - [blog post: I did not want to write this blog post.](https://joebakcoleman.com/blog/2024/protzko/)
		        #inpeer/evdInfra/impacts/reactions/meta/dynamics/longForm
			        #inpeer/evdInfra/where/multimedia/blog/personal
                - Markdown
                    - --
                    ...
                    - At this point, I thought surely the authors would own up to their mistakes and I would not have to write this blog post. All along, I have hoped the authors would acknowledge their mistakes and move on. I held out some shred of belief that people who have built careers on honesty, transparency, and openness could be honest, open, and transparent. I was naive.
                        - ![](https://joebakcoleman.com/assets/img/nosek.png)
    ...
    - Scholarly: outcomes for formal scholarly record like retractions, corrections, notices, etc.
        ...
        - Change history: [[editorial concerns]] then [[retractions]]
            - 11 December 2023
            ...
            - 24 September 2024
                - This article has been **^^retracted^^**. Please see the Retraction Notice for more detail: [https://doi.org/10.1038/s41562-024-01997-3](https://doi.org/10.1038/s41562-024-01997-3)
    - Behavioral Economics: its value/risks; who is doing it, why, and rewards/risks
        - There are certainly risks toying with the open science and metascience elites in this paper like Brian Nosek, but Bak-Coleman is an elite academic himself rising in collective behavior and metascience. He seems to be doing it for the intrinsic value of correcting the scholarly record and wants others to know that the the paper has numerous issues that weaken its claims: preregistration deviation, outcome switching, and downplaying the formal and informal peer reviews that question the credibility of @protzko2024high.
	        - #inpeer/why/benefits/review/intrinsic/correctSpin
		        - This means that someone was motivated to engage in informal peer reviews because the formal reviews, scholarly commentary, and nonscholarly commentary were misrepresenting what actually occurred.
    - Sociology of Science:
        - intersections with science reform structures and movements
            - The open science pioneers, including Nosek, Nelson, Schooler, and Ebersole, have significant international influence. They are the ones who ought to model the values Transparency, Openness, and Rigor. Here, it seems like the formal and informal peer reviewers did not find those values expressed in @protzko2024high.
            ...
            - Joe Bak-Coleman, like Berna Devezer. and Jessica Hullman, could be considered part of the open science counterculture. All of these scholars use open practices, but have a more critical POV regarding the necessity of certain practices and whether they are sufficient for high-quality scholarship.
	            - #inpeer/who/reviewer/roles/expert/fields/openSci/advocate/cautious
		            - This means that the individual(s) is/are open science advocates, but are skeptical that it is necessary and sufficient. There are frictions here between bropenscience and moderates.
    ...
    - Storytelling: What is the style/genre/frame of critical appraisal?
        ...
        - [[affective critical appraisal]]: mournful in this case
	        - #inpeer/how/practices/review/paper/frames/affective
- **Observer**: Jay Patel
- **Date of Observation**: [[October 9th, 2024]]
- **Duration of Observation**: one day for a loose memo, one day for structured memo
- **Event or Activity Observed**: appraisal...
- **Description**: We will ask ourselves:
    - How was the case discovered?
        - JP found a link to it on microblogging platforms like X/Twitter and Bluesky.
    - Was the observation a partial or a complete session?
        - complete session
    - What occurred? Which concerns were raised and by whom?
        - [[Joe Bak-Coleman]] recounts an opportunity he gave the authors of @protzko2023 to self-retract their paper during Nov 2023. This did not happen and he finds the downplaying of this retraction saga troubling. He's frustrated and saddened...
            - > "I had emailed the authors and provided a very clear outlined draft and code comparison indicating that virtually none of the analyses matched the preregistration. One or two analyses is a mistake, the entire main text is a _problem_. Brian had to have known the issues were much more substantial than he let on, and posted in a way that minimized the seriousness of the issues."
	            - #inpeer/evdInfra/impacts/reactions/publishers/revisions/lethargic/zombiePaper
		            - Here I want to update this code to include papers that were given a chance to be retracted but were not and also retractions that were given the opportunity to be resubmitted as a new manuscript.
        - This is more than a preregistration issue. New documents provided by the study co-authors indicate several QRPs:
	        - #inpeer/how/practices/review/paper/layers/empirical/rigor/qrp/multiple
		        - This means that multiple questionable research practices (QRPs) are evident in the scholarly report.
            - Outcome Switching
	            - #inpeer/how/practices/review/paper/layers/empirical/rigor/qrp/outcomeSwitching
		            - This means that the credibility of a scholarly report is undermined due to outcome switching, or changing the dependent variable (could be between the preregistration and the study's data collection + analysis).
            - Falsification
	            - ???
            - HARKing
				- #inpeer/how/practices/review/paper/layers/empirical/rigor/qrp/harking
					- This means that the credibility of a scholarly report is undermined due to hypothesizing after the results are known (HARKing).
            - Omissions of pilots
                - Selective reporting of analyses and data
	                - #inpeer/how/practices/review/paper/layers/empirical/rigor/qrp/selectiveReport/analyses
		                - This means that the credibility of a scholarly report is undermined due to selective (omitted) reporting of analyses.
    - Who participated?
        - [[Joe Bak-Coleman]]
    - Were decisions made, actions taken, or goals accomplished? What was left unresolved?
        - A notice of Editorial Concern appeared then a retraction.
        - Regarding Joe's blog post, I've haven't found any decisions made.
    - By whom and how, and after what deliberations or conversations?
        - Joe is the author of this post, but it is entangled with posts by Hullman, Lakens, Gelman, and Yarkoni.
    - What are their roles and skills?
        - Joe Bak-Coleman earned his Ph.D. in Ecology from Princeton and is a computational social scientist. Not sure how that happened, but he's statistically very savvy, a skilled [[statistical sleuths]], and a metascientist. He seems to have the skills, like Berna Devezer and Jessica Hullman, to tackle a difficult project like this.
	        - #inpeer/who/reviewer : knows his metascience
			- #inpeer/who/reviewer/roles/expert/fields/interdisciplinaryScholar
				- This means that the individual is an interdisciplinary scholar.
			- #inpeer/who/reviewer/roles/expert/fields/metascientist
				- This means that the individual is a metascientist.
			- #inpeer/who/reviewer
			- #inpeer/who/reviewer/roles/expert
    - Are there follow-ups or next steps for anyone involved?
        - [ ] JP: [[active participant observation]]: fill in some details on PubPeer to synthesize these remarks
	        ...
	        - #inpeer/digitalEthnography/activePartObs/tell/what/minorElaboration
		        - This means that I engaged in active participant observation with the study co-authors by engaging in minor elaboration of their post. For example, I noted in a BlueSky DM that I appreciated the posts in a brief, general statement.
        - _Nature Human Behavior_ has some explaining to do. Are they saving their reputation by allowing a resubmission? Like Nosek, they seem to be downplaying the issues with the history of @protzko2024.
	        - #inpeer/evdInfra/problems/publishing/laxStandards
	        - #inpeer/evdInfra/impacts/reactions/meta/dynamics/ongoingResearchContinues
	        -  #inpeer/evdInfra/impacts/reactions/publishers/revisions/lethargic/selfpreservation/halfheartedRemediation/retractionAllowResubmission
		        - This means that the journal that retracted a scholarly paper allows the study co-authors to resubmit to the same journal.
    - What were my feelings about its sophistication and ease of authoring?
        - This was a difficult post to author emotionally and temporally. The energy required to produce it quickly on a placeholder website while working a full-time job is really something.
    - If retractions, corrections, and expressions of editorial concern are issued, then can we dig deeper into why they were possible and how long they required?
        - Well, the retraction required a full year which is not quick.
	        - #inpeer/evdInfra/impacts/reactions/publishers/revisions/retractions/delayed
		        - This means that the retraction required more than a few week or months. Such retraction may require a year or longer despite critiques of the scholarly report.
    - How many similar examples of informal peer review are hiding elsewhere and how might one surface them?
        - What are the analogues of this kind of InPeeR across other communities? As a metascientist and psychologist with a life sciences background, it's not surprising that I can examples in each of those three domains. I'm sure there are equivalents in the arts, humanities, and engineering sciences.
    - Did I engage in active participant observation? If so, what did I do and how was it received? Which conceptual and technological tools did appraisers use?
        - Well, I engaged in a few Bluesky chats and got the following DM by remarking that the motives how hiding the issues in @protzko2024 aligned with other papers.
            - Note: Anonymize the source:
				- REDACTED DUE TO ANONYMIZATION
					- #inpeer/digitalEthnography/activePartObs/integrate/privateChat
						- This means that I, JP, engaged in active participant observation such that I was able to privately chat with an anonymous sleuth about an informal peer review.  
- **Reflection**: What was your experience in this session: as a participant? as a participant-observer?
    - What stood out to you about this session, in light of our research problem?
        - Time, money, energy, software, and cultural support are lacking for InPeeR, as noted by Joe "**^^"Mostly, I don’t have the time to write this. I work a 9-to-5, am writing a book, and have science to do. My website broke so I’ve slapped it up temporarily on a placeholder website… I don’t have time to fix it."^^**."
	        - #inpeer/evdInfra/problems/reviews/informal/fewResources
		        - This means that the infrastructure of informal peer reviews is too weak to support itself. The volunteered review occurred despite low resources.
    - What was interesting or concerning or confusing?
        - Diverse inputs
            - I found it interesting that the case brought out critical remarks about @protzko2024 from formal and informal peer reviews.
	            - #inpeer/who/network/diverseInputsinCase
		            - This means that the informal peer reviewers were diverse methodologically and disciplinarily.
        - Aligning research to funders
            - It appears as though the decline effect's supernatural framing came later presumably to appeal to the Templeton Foundation's philosophical view:
                - > "This utterly batshit supernatural framing erodes en route to the the published manuscript. Instead, **^^the authors refer to these primary hypotheses that date back to the origin of the project as phenomena of secondary interest and do not describe the hypotheses and mechanisms explicitly^^**. They refer only to this original motivation in the supplement of “test of unusual possible explanations.”"
                - > "In distancing themselves for [two of the three reasons they got funding](https://www.fetzer-franklin-fund.org/projects/deciphering-the-decline-effect-1/) **^^they mislead the reader about what they set out to study and why. This isn’t a preregistration issue. This is outcome switching, and lying.^^** It’s almost not even by omission because they say it’s the fringes of scientific discourse but it’s the senior author on the paper!"
	                - #inpeer/evdInfra/problems/reviews/formal/appeaseGrantfunders
		                - This means that the infrastructure of scholarship requires framing a study in a particular way for it to be funded.
            - the Open Science Framework (OSF) [[sys/OSF]] is a mess to read, so no wonder people don't check preregistrations
                - > "I have little doubt some will remain unconvinced because this post was tl;dr and **^^the files are td;dr (too disorganized, didn’t read)^^**."
	                - #inpeer/evdInfra/problems/technical/repo/messy
		                - This means that open science platforms like the OSF are too messy for the files to be read, understood, and synthesized.
    - Flesh out any jotted notes on your thoughts, ideas, questions, and concerns as you were conducting the observation.
        - cc [[Joel Chan]]
            - It is difficult to study and synthesize multiple lengthy InPeeRs, so carefully developing a UI for authoring and studying InPeeRs may help us get up to speed. Here, [[[[ART]] - PubPeer]] is the old world with their top-to-bottom forum UI. Can we consider other options like [[discourse graph]]s and [[canvas UI(s)]]?
	            - #discussion/implications/peerReview/tools/pubpeer/badUX
	            - #discussion/implications/peerReview/tools/pubpeer/designUI
		            - This means that it would be useful to design PubPeer's UI to enable a synthesis of what is currently being discussed about a scholarly report.
    - What are the implications for evolving:
        - formal peer review?
            - Formal peer review detected some of the issues, as found in posts by [[Tal Yarkoni]]. We need a way to push such reviews into the open and improve their discovery.
	            - #discussion/implications/peerReview/practices/social/publicizeFormalreviews
		            - This means that we should publicize formal peers alongside the paper to uncover the critiques.
