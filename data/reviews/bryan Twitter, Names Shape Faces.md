...
- [[>]] The hardest thing to explain to non-academics is how different technical rigor is across fields. Here's (yet another) article in PNAS, of course handled by Fiske, of course in psych, that we would have desk rejected. Paper is "Can Names Shape Facial Appearance?" 1/n [🐦](https://x.com/Afinetheorem/status/1818297553143595223) by Kevin A. Bryan on [[July 30th, 2024]]
	- #inpeer/who/reviewer/roles/unconventional/domainOutsider
		- He's an economist and biz strategy expert with math and stats expertise (MS Math). No psych experience or credentials, though.
...
- Markdown
	...
	- Also isn’t the easier explanation that names and appearances are correlated with culture and maybe these cultural facial differences are more distinct for adults. Like wouldn’t be hard to tell Chang from Jose. I imagine facial features could be just less d