---
type: review
noteID: fe1256c1-fec4-4ab7-a0e5-37bb1c828466
status: complete
...
Translational Psychiatry (2024) - 4 Comments
pubmed: 38316750  doi: 10.1038/s41398-024-02736-y  issn: 2158-3188 

___

Jaber Alizadehgoradel ![author has email](https://pubpeer.com/img/verified.svg) , Behnam Molaei ![author has email](https://pubpeer.com/img/verified.svg) , Khandan Barzegar Jalali , Asghar Pouresmali , Kiomars Sharifi , Amir-Homayun Hallajian , Vahid Nejati , Benedikt Glinski , Carmelo M. Vicario , Michael A. Nitsche ![author has email](https://pubpeer.com/img/verified.svg) , Mohammad Ali Salehinejad ![author has email](https://pubpeer.com/img/verified.svg)
...
[![file](https://pubpeer.com/storage/image-1719065561693.png)](https://pubpeer.com/storage/image-1719065561693.png)
...
==Lastly, I must clarify that these are peer-reviewed articles assessed by experts in the field, who are acquainted with the typical and necessary sample size in NIBS studies.==
	...
	- [ ] #inpeer/how/practices/sociotechnical/social/elitePower ?
...
Thanks to the authors for depositing raw data on OSF. I think the BDI data are missing from the 'clinical meassures.xlsx' file. For completeness, it would be good to have these. Thanks
	#inpeer/how/practices/review/paper/layers/empirical/openness/practices/performative ?
		#inpeer/how/practices/review/paper/layers/empirical/openness/data/needed/requestFail
			#inpeer/how/practices/review/paper/layers/empirical/openness/data/needed/missedSubset
				This means that the raw data the study authors provided was not enough for an informal peer reviewer or organization. They desire a missing subset of data for completeness.